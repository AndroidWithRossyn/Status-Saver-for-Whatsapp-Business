...
public class CleanerAdapter extends Adapter<RecyclerView.ViewHolder> {
    int audios = 3;
    int document = 4;
    int gif = 5;
    int images = 1;
    ...
    public class ViewHolderAudios extends RecyclerView.ViewHolder implements OnClickListener {
        public CheckBox checkBox;
    ...
    public class ViewHolderDocs extends RecyclerView.ViewHolder implements OnClickListener {
        public CheckBox checkBox;
    ...
    public class ViewHolderVideos extends RecyclerView.ViewHolder implements OnClickListener {
        public CheckBox checkBox;
        public ImageView imagevi;
