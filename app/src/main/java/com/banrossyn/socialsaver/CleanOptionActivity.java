...
public class CleanOptionActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    void onTapBtn(String category, String receivePath, String sentPath) {
        if (Utils.iswApp) {
            if (com.banrossyn.socialsaver.util.Utils.appInstalledOrNot(CleanOptionActivity.this, "com.whatsapp")) {
            ...
            if (com.banrossyn.socialsaver.util.Utils.appInstalledOrNot(CleanOptionActivity.this, "com.whatsapp.w4b")) {
                onTTap(category, receivePath, sentPath);
            } else {
    ...
    void oTOther(String category, String path) {
        Intent intent = new Intent(this, WACleanerActivity.class);
        intent.putExtra("category", category);
