...
import com.kessi.statussaver.adapter.FullscreenImageAdapter;
...
public class PagerPreviewActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                if (!AdManager.isloadFbAd) {
                    ...
                    AdManager.adCounter++;
                    AdManager.showMaxInterstitial(PagerPreviewActivity.this, null,0);
                }
            }
        ...
        if (!AdManager.isloadFbAd) {
            ...
            //MAX + Fb banner Ads
            AdManager.initMAX(PagerPreviewActivity.this);
            AdManager.maxBanner(PagerPreviewActivity.this, adContainer);
            AdManager.maxInterstital(PagerPreviewActivity.this);
        }
